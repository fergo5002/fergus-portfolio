...
export const splitTextSeo: Article = {
  ...
  description:
    "Per-character text animations are everywhere. They also quietly turn your most important headline into gibberish for the crawlers that read your site. Here is the fix.",
  date: "2026-08-20",
...
The homepage headline is my name. It animates in one character at a time, because that looks good and because the whole site is pretending to be a CRT terminal. To do that, the name is split into one element per letter. Standard stuff. GSAP's SplitText does it, Framer Motion's stagger examples do it, and every "animated hero text" tutorial you have ever read does it.
